...
/** @author Gabriel*/
public class RegistroAlumnosUlp1 extends javax.swing.JFrame {
    public static Inscripciones JIInsc = new Inscripciones();
    public RegistroAlumnosUlp1() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistroAlumnosUlp1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistroAlumnosUlp1().setVisible(true);
            }
        });
    }
